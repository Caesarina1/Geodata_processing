...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Education_and_webinars\Prog\Beetroot\Project\Geodata_processing_system\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Education_and_webinars\Prog\Beetroot\Project\Geodata_processing_system\venv\Scripts\deactivate.nu'
